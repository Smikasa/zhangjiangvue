    ...
    mapData() {
      if (this.area === "world") {
        ...
        this.mapPeopleSpread.setOption({
          ...
          series: this.getMapSeries("云南", this.mapData),
        });
      }
      this.getTotal(this.mapData);
    },
  },
  mounted() {
    this.initMap();
        ...
        tooltip: {
          ...
          formatter: function (params) {
            if (params.data.value) {
              let res =
                "<span>城市：</span><span style='color:#fff;padding-right:5px;'>" +
                params.name +
                "</span> <br /><span>数量：</sapn><span style='padding-right:5px;'>" +
                params.value[2] +
                "</span>";
              return res;
            } else {
