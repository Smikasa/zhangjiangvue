      ...
      <div class="left-top clearfix">
        <div class="fl left-top-number">
          ...
          <div>
            <ul class="clearfix tab">
              <li class="tab-pane fl"
                  :class="[curPeopleNumber === 5 ?'active':'']"
                  @click="changCurPeopleNumber(5)">5分钟</li>
              <li class="tab-pane fl"
                  :class="[curPeopleNumber === 15 ?'active':'']"
                  @click="changCurPeopleNumber(15)">15分钟</li>
            </ul>
          </div>
          <div id="peopleNumber"
               class="people-number"
               clstyle="width: 515px;height: 424px;"></div>
        </div>
        <div class="fr left-top-terminal">
          ...
          <div>
            <div id="terminal"
                 class='terminal'
                 style="width: 521;height: 423px;"></div>
          </div>
        </div>
      </div>
        ...
        <div>
          <ul class="clearfix tab">
            <li class="tab-pane fl"
                ...
                @click="changCurPeopleSpread(0)">地图</li>
            <li class="tab-pane fr"
                :class="[curPeopleSpread === 1 ?'active':'']"
                @click="changCurPeopleSpread(1)">列表</li>
          </ul>
        </div>
        <div v-show="curPeopleSpread === 0">
          ...
          <div class="map-contain">
            ...
            <div style="display: none;"
                 class="areaFrom">
              <!-- <img :src="@/pages/assets/img/area-from-bg.png"
                   alt=""
                   srcset=""></div> -->
              <div class="map-btns clearfix">
                <div class="fl"
                     :class="[curMapArea === 'china' ? 'active' : '']"
                     @click="changSpreadMap('china')">境内人员分布</div>
                <div class="fl"
                     :class="[curMapArea === 'world' ? 'active' : '']"
                     @click="changSpreadMap('world')">境外人员分布</div>
                <div class="fl"
                     :class="[curMapArea === 'province' ? 'active' : '']"
                     @click="changSpreadMap('province')">省内人员分布</div>
              </div>
            ...
            <div class="map-table-contain">
                ...
                <div class="table-item clearfix"
                  ...
                  <div class="table-progress fl clearfix">
                    <div class="table-progress-bg">
                      <div class="table-progress-pro fl"
              ...
              <div class="map-table-btns clearfix">
                <div class="fl"
                     ...
                     @click="changSpreadMapTable('china')">境内</div>
                <div class="fl"
                     :class="[curMapTableArea === 'world' ? 'active' : '']"
                     @click="changSpreadMapTable('world')">境外</div>
                <div class="fl"
                     :class="[curMapTableArea === 'province' ? 'active' : '']"
                     @click="changSpreadMapTable('province')">省内</div>
              </div>
            </div>
          </div>
        </div>
